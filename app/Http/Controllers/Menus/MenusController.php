...
class MenusController extends Controller
{
    public static function addMenu(Request $request)
    {
        ...
        return response()->json(["success" => true, "menus" => MenusModel::all(), 'item' => $menu]);
    }
    ...
    public static function editMenu(Request $request)
    {
        ...
        return response()->json(["success" => true, "menus" => $menuItems, 'item' => $menuItem]);
	...
	public static function getAllChildrenMenus(Request $request)
    {
        $rules = [
            "id" => "required|int",
        ];
        ...
        $menuItems = MenusModelContent::where("parent_id", "=", $request->get("id"))->orderBy("order")->get();
        if (!$menuItems) {
            return response()->json(["success" => false, "message" => "Items not found"]);
        }
        return response()->json(["success" => true, "items" => $menuItems]);
