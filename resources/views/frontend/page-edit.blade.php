					  ...
					  <div class="row">
						...
						<div class="col-4">
						     <div class="m-2">
						       ...
						       <input class="form-control" name="slug" type="text" id="slug" placeholder="Slug">
					         </div>
						 </div>
    ...
    theme: 'snow'
           ...
           window.Flex.Component.Page.Store.Command.getPage({
				...
				imageDOM.setAttribute("height", "auto");    
				 ...
				 let xButtonDOM = document.createElement('span');
				  ...
				  xButtonDOM.addEventListener('click', (i,j) => {
					...
					document.querySelector('#title_en').value = r.data.data.page.title_en;
					document.querySelector('#title_ru').value = r.data.data.page.title_ru;
					...
					document.querySelector('#description_en').value = r.data.data.page.description_en;
					document.querySelector('#description_ru').value = r.data.data.page.description_ru;
					quill.root.innerHTML = r.data.data.page.content;
					quill_en.root.innerHTML = r.data.data.page.content_en;
					quill_ru.root.innerHTML = r.data.data.page.content_ru; 
			...
			document.querySelector('[data-update-page]').addEventListener('click', () => {
				...
				window.Flex.Component.Page.Store.Command.update($("#page_form")[0]).then((r) => {
