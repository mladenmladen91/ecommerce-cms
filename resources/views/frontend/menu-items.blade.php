			...
			<div class="modal-body">
				<form>
					...
					<div class="inputWrapper  m-2 ">
						...
						<input class="form-control" type="text" id="name_en" placeholder="Naziv EN">
					</div>
					<div class="inputWrapper  m-2 ">
						<label for="name">Naziv RU</label>
						<input class="form-control" type="text" id="name_ru" placeholder="Naziv RU">
					</div>
					<div class="inputWrapper  m-2 ">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<form>
					...
					<div class="inputWrapper  m-2 ">
						<label for="name">Naziv EN</label>
						<input class="form-control" type="text" id="name_en2" placeholder="Naziv EN">
					</div>
					<div class="inputWrapper  m-2 ">
						<label for="name">Naziv RU</label>
						<input class="form-control" type="text" id="name_ru2" placeholder="Naziv RU">
					</div>
					<div class="inputWrapper  m-2 ">
						<label for="discount_id">Izaberi stranicu</label>
						<select class="form-control" id="link">
...
<script>
	document.addEventListener('DOMContentLoaded', () => {
		...
		document.querySelector('[data-save-category]').addEventListener('click', () => {
			...
			let name_en = document.querySelector('#addPageModal').querySelector('#name_en').value;
			let name_ru = document.querySelector('#addPageModal').querySelector('#name_ru').value;
		...
		document.querySelector('[data-update-category]').addEventListener('click', () => {
			...
			let name_en = document.querySelector('#updatePageModal').querySelector('#name_en2').value;
			let name_ru = document.querySelector('#updatePageModal').querySelector('#name_ru2').value;
