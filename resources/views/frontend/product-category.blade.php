            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="inputWrapper  m-2 ">
						...
						<input class="form-control" type="text" id="name" name="name" placeholder="Naziv">
					</div>
					<div class="inputWrapper  m-2 ">
						<label for="name">Naziv EN</label>
						<input class="form-control" type="text" id="name_en" name="name_en" placeholder="Naziv EN">
					</div>
					<div class="inputWrapper  m-2 ">
						<label for="name">Naziv RU</label>
						<input class="form-control" type="text" id="name_ru" name="name_ru" placeholder="Naziv RU">
					</div>
					 <div class="inputWrapper  m-2 ">
					...
					<div class="inputWrapper  m-2 ">
						...
						<input class="form-control" type="text" id="description" name="description" placeholder="Opis">
					</div>

					<div class="inputWrapper  m-2 ">
						 <label for="description">Opis EN</label>
						<input class="form-control" type="text" id="description_en" name="description_en" placeholder="Opis EN">
					</div>

					<div class="inputWrapper  m-2 ">
						 <label for="description">Opis RU</label>
						<input class="form-control" type="text" id="description_ru" name="description_ru" placeholder="Opis RU">
					</div>	
						
					<div class="inputWrapper  m-2 ">
						 <label for="slug">Fotografija</label>
						<input class="form-control" name="image" type="file" name="image" />
                    </div>	
						
					<div class="inputWrapper  m-2 ">
						<label for="category_id">Roditeljska kategorija</label>
						<select class="form-control" id="parent_id" name="parent_id" data-category-select>
						    <option value="">-----</option>
						</select>
					</div>
                    </form>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="inputWrapper  m-2 ">
						<label for="name">Naziv</label>
						<input class="form-control" type="text" id="name2" name="name" placeholder="Naziv">
						<input type="hidden" name="id" id="id">
                     </div>
					 <div class="inputWrapper  m-2 ">
						<label for="name">Naziv EN</label>
						<input class="form-control" type="text" id="name_en2" name="name_en" placeholder="Naziv EN">
					</div>
					<div class="inputWrapper  m-2 ">
						<label for="name">Naziv RU</label>
						<input class="form-control" type="text" id="name_ru2" name="name_ru" placeholder="Naziv RU">
					</div>
					 <div class="inputWrapper  m-2 ">
						 <label for="slug">Slug</label>
						<input class="form-control" type="text" id="slug2" name="slug" placeholder="Slug">
						
                    </div>
						
					<div class="inputWrapper  m-2 ">
						 <label for="description2">Opis</label>
						<input class="form-control" type="text" id="description2" name="description" placeholder="Opis">
					</div>

					<div class="inputWrapper  m-2 ">
						 <label for="description2">Opis EN</label>
						<input class="form-control" type="text" id="description_en2" name="description_en" placeholder="Opis EN">
					</div>

					<div class="inputWrapper  m-2 ">
						 <label for="description2">Opis RU</label>
						<input class="form-control" type="text" id="description_ru2" name="description_ru" placeholder="Opis RU">
					</div>	
					...
					<div class="inputWrapper  m-2 ">
						<label for="category_id">Roditeljska kategorija</label>
						<select class="form-control" name="parent_id" id="parent_id2" data-category-select>
						    <option value="">-----</option>
						</select>
					</div>
                    </form>
...
function children2(item, tableDOM, parentDOM = null){
	...
	dDOM.addEventListener('click', (i,j) => {
					...
					updateModal.querySelector('#name_en2').value = item.name_en;
					updateModal.querySelector('#name_ru2').value = item.name_ru;
					updateModal.querySelector('#slug2').value = item.slug;
		            updateModal.querySelector('#description2').value = item.description;
					updateModal.querySelector('#description_en2').value = item.description_en;
					updateModal.querySelector('#description_ru2').value = item.description_ru;
	...
	if(item.children.length > 0){
		...
		item.children.forEach((item)=>{
            ...
            document.querySelector('[data-save-category]').addEventListener('click', () => {
                ...
                window.Flex.Component.ProductCategory.Store.Command.add($("#add_category_form")[0]).then((r) => {
            ...
            document.querySelector('[data-update-category]').addEventListener('click', () => {
               ...
               window.Flex.Component.ProductCategory.Store.Command.update($("#edit_category_form")[0]).then((r) => {
                     location.reload();
                }).catch((r) => {
